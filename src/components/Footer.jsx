function Footer() {
  return (
    <div className="container-fluid bg-dark">
      <footer className="d-flex flex-wrap justify-content-center align-items-center py-3 border-top border-primary">
        <div className="d-flex align-items-center">
          ...
          >
            ...
            <span className="mb-3 mx-2 mb-md-0 text-primary">
              Borja Tapia {new Date().getFullYear()} ©
            </span>
          </a>
        </div>
      </footer>
